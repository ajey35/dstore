...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    outline:
      'border border-slate-700 hover:bg-slate-800/60 text-slate-200 focus:ring-emerald-500',
    danger:
      'bg-rose-600 hover:bg-rose-500 text-white shadow-lg shadow-rose-600/20 focus:ring-rose-500',
    ghost:
      'hover:bg-slate-800/50 text-slate-300 hover:text-slate-100 focus:ring-slate-500',
  };
